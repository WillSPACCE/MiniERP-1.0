...
CREATE TABLE `fiscal_certificates` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_active_certificate` (`tenant_id`,`establishment_id`,`active`),
...
INSERT INTO `fiscal_order_items` VALUES (9,6,7,1.0000,4123.5000,0.00,0.00,0.00,0.00,4123.50,4123.50),(12,5,7,1.0000,4123.5000,0.00,0.00,0.00,0.00,4123.50,4123.50);
...
-- Dump completed on 2026-08-21 20:25:41
