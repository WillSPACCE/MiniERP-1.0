...
INSERT INTO `cfops` VALUES (2,'5102','Venda de mercadoria adquirida ou recebida de terceiros','Saída','','ativo'),(3,'1102','Compra para comercialização','Entrada','Dentro do Estado','ativo'),(4,'2102','Compra para comercialização','Entrada','Interestadual','ativo'),(5,'6102','Venda de mercadoria adquirida ou recebida de terceiros','Saída','Interestadual','ativo');
...
INSERT INTO `establishment_cfop_defaults` VALUES (1,14,5,'ENTRY_INTERNAL','1102','2026-08-24 14:23:28','2026-08-24 14:23:28'),(2,14,5,'ENTRY_INTERSTATE','2102','2026-08-24 14:23:28','2026-08-24 14:23:28'),(3,14,5,'EXIT_INTERNAL','5102','2026-08-24 14:23:28','2026-08-24 14:23:28'),(4,14,5,'EXIT_INTERSTATE','6102','2026-08-24 14:23:28','2026-08-24 14:23:28');
...
INSERT INTO `establishment_fiscal_settings_audit` VALUES (1,14,5,'CFOP_BOOTSTRAP_PROMPT_020',0,NULL,'{\"ENTRY_INTERNAL\":\"1102\",\"ENTRY_INTERSTATE\":\"2102\",\"EXIT_INTERNAL\":\"5102\",\"EXIT_INTERSTATE\":\"6102\"}','2026-08-24 14:24:04');
...
CREATE TABLE `fiscal_certificates` (
  ...
  `sha256` char(64) NOT NULL,
  `thumbprint_sha1` char(40) DEFAULT NULL,
  ...
  `last_signature_test` datetime DEFAULT NULL,
...
-- Dump completed on 2026-08-24 12:05:05
