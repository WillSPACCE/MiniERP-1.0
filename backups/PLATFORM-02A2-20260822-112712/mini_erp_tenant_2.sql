...
--
-- Host: 127.0.0.1    Database: mini_erp_tenant_2
-- ------------------------------------------------------
...
--
-- Current Database: `mini_erp_tenant_2`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mini_erp_tenant_2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;

USE `mini_erp_tenant_2`;
...
INSERT INTO `clientes` VALUES (1,'Cliente Exemplo 2','cliente2@example.com','','10000000002','','','','','','','','','','','ativo','','cliente','sim',NULL,'',NULL,'','','','','','','','','','','','',NULL,'','','','',0.00,0.00,'','','','','',0.00,0.00,NULL),(2,'José Almeida','jose@empresa.com','(11) 98888-2222','','','','','','','','','','','Rio de Janeiro','ativo','','cliente','sim',NULL,'',NULL,'','','','','','','','','','','','',NULL,'','','','',0.00,0.00,'','','','','',0.00,0.00,NULL),(3,'Ana Costa','ana@empresa.com','(11) 97777-3333','','','','','','','','','','','Belo Horizonte','ativo','','cliente','sim',NULL,'',NULL,'','','','','','','','','','','','',NULL,'','','','',0.00,0.00,'','','','','',0.00,0.00,NULL);
...
INSERT INTO `produtos` VALUES (1,'Café Premium 1kg','GROC-COF-001','','','UN','','','',39.90,100,'ativo',NULL),(2,'Açúcar Cristal 1kg','GROC-SUG-001','','','UN','','','',4.50,200,'ativo',NULL),(3,'Azeite Extra Virgem 500ml','GROC-OIL-001','','','UN','','','',24.90,60,'ativo',NULL),(4,'Notebook Pro','NBP-500','','','UN','','','Computadores',3499.00,5,'ativo',NULL);
...
INSERT INTO `usuarios` VALUES (1,'Gerente Supermercado','gerente2@localhost','$2y$10$JvVkh3y/ERmnPo.7VQLxeenAlHXcB.u6fH2QFHRy9FJIvmlCpCs2u','manager','','ativo',NULL,0,NULL,NULL,'funcionario'),(2,'Vendedor B','vendedor2@localhost','$2y$10$SUUnFSxFNC53e58phgR.mex3.hEJctrzjA8Z7aF4uJMd3N76A0pMm','user','','ativo',NULL,0,NULL,NULL,'funcionario');
...
--
-- Dumping events for database 'mini_erp_tenant_2'
--

--
-- Dumping routines for database 'mini_erp_tenant_2'
--
