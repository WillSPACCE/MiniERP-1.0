...
orderTestFillAssert(str_contains($js,"document.querySelector('[data-order-test-fill]')")&&str_contains($js,"window.PRODUCTS")&&str_contains($js,"selectRandom('cfop_id')")&&str_contains($js,'randomItem(options)'),'OrderTestFillRequiredDataTest');
orderTestFillAssert(str_contains($js,'shuffledProducts.slice(0, itemCount)')&&str_contains($js,'addItem(product, { quantidade:'),'OrderTestFillRandomRegisteredProductsTest');
