...
orderTestFillAssert(str_contains($page,"(int)(\$currentUser['id'] ?? 0) === 9")&&str_contains($page,"strtolower((string)(\$currentUser['role'] ?? '')) === 'admin'"),'OrderTestFillAdminNineGateTest');
