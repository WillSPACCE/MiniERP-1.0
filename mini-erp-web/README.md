...
### Versão funcional em PHP (SQLite local)
...
```text
http://127.0.0.1:8000/index.php?page=dashboard
```

> A base de dados atual usa SQLite local para manter o sistema funcional sem depender imediatamente de MySQL instalado e configurado.

### Variante com XAMPP/MySQL
